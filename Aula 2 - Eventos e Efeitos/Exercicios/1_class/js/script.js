/*
  ...
  ATENÇÃO! As informações devem  estar guardadas em variáveis!
...
$(document).ready(function(){
    const nickname = 'Maria';
const favoritos = 'Princesa Mononoke';
const cidade = 'São Paulo';
let favDoMomento = 'Moving the castle'
$('body').css('font-family','Arial, sans-serif')



$('#nickname').text('Maria')
$('#favoritos').text(['Princesa Mononoke, moving the castle'])
